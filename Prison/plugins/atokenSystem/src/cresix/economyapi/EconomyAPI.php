...
use cresix\economyapi\provider\Provider;
use cresix\economyapi\provider\YamlProvider;
use cresix\economyapi\provider\MySQLProvider;
use cresix\economyapi\event\money\SetMoneyEvent;
use cresix\economyapi\event\money\ReduceMoneyEvent;
use cresix\economyapi\event\money\AddMoneyEvent;
use cresix\economyapi\event\money\MoneyChangedEvent;
use cresix\economyapi\event\account\CreateAccountEvent;
use cresix\economyapi\task\SaveTask;
...
class EconomyAPI extends PluginBase implements Listener{
	...
	public function onEnable(){
		...
		§l§c❤§b Plugin §ePointAPI§b edit by §ePhuongaz
	...
	private function registerCommands(){
		...
		$commands = [
			"mytoken" => "\\cresix\\economyapi\\command\\MyMoneyCommand",
			"toptoken" => "\\cresix\\economyapi\\command\\TopMoneyCommand",
			"settoken" => "\\cresix\\economyapi\\command\\SetMoneyCommand",
			"seetoken" => "\\cresix\\economyapi\\command\\SeeMoneyCommand",
			"givetoken" => "\\cresix\\economyapi\\command\\GiveMoneyCommand",
			"taketoken" => "\\cresix\\economyapi\\command\\TakeMoneyCommand",
			"paytoken" => "\\cresix\\economyapi\\command\\PayCommand",
			"setlangt" => "\\cresix\\economyapi\\command\\SetLangCommand",
			"mystatust" => "\\cresix\\economyapi\\command\\MyStatusCommand"
		];
