...
use SpeedEffect\economy\EconomyManager;
use SpeedEffect\lang\LangManager;
use SpeedEffect\tasks\CoolDownTask;
...
class Main extends PluginBase{
    ...
    public function onEnable() : void{
        ...
        if(($plugin = $this->getServer()->getPluginManager()->getPlugin('FormAPIPlus')) !== null){
            $this->formAPIInstance = $plugin;
            $this->getLogger()->notice('FormAPIPlus detected. Activated kit selection UI support');
        }
