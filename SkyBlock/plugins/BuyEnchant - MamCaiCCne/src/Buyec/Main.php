   ...
   if(!$sender instanceof Player){
     ...
     if(!isset($args[0]) && isset($args[1])) {
	   ...
	   return true;
        ...
        $sender->sendMessage("§4ID Nâng Cấp Chỉ Giới Hạn Từ §a1 Đến §a100 Thôi Nhé");
        return true;
        }
...
$form->setTitle("§e§lCresix §6Block §e");
$form->addInput("§l§b•Id Enchant");
$form->addInput("§l§b•Level để enchant");
...
$form->sendToPlayer($sender);
   ...
   break;
		...
		$api = $this->getServer()->getPluginManager()->getPlugin("FormAPI");
						...
						$form->setTitle("§e§lCresix Enchant §e(§dID ENCHANT§e)");
