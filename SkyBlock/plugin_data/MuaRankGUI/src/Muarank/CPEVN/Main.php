...
class Main extends PluginBase implements Listener{
	...
	public function rank1(Player $sender){
		...
		$form->setContent("• §eMua §aVIP§e-§cI §evới giá 10 Point,bạn có muốn mua không?Các quyền lợi của §aVIP§e-§cI §eáp dụng từ ngày 2/4\n §c►§a /tp");
		$form->setButton1("• §atap để mua", 1);
	...
	public function getItem($sender){
		...
		$item->setCustomName("• §aThanh kiếm vip1");
	...
	public function rank2(Player $sender){
		...
		$form->setContent("• §eMua §aVIP§e-§cII §evới giá 35 Point,bạn có muốn mua không?Các quyền lợi của §aVIP§e-§cII §eáp dụng từ ngày 2/4\n §c►§a /tp\n §c►§a /fly");
		$form->setButton1("• §atap để mua", 1);
		$form->setButton2("• §cHủy bỏ", 2);
		$form->sendToPlayer($sender);
	}
	...
	public function rank3(Player $sender){
		...
		$form->setTitle("•§e Mua§6 VIP§f •");
		$form->setContent("• §eMua §aVIP§e-§cIII §evới giá 65 Point ,bạn có muốn mua không?Các quyền lợi của §aVIP§e-§cIII §eáp dụng từ ngày 2/4\n §c►§a /tp\n §c►§a /fly\n§c►§a /kichthuoc\n§c ►§a /canh");
		$form->setButton1("• §atap để mua", 1);
		$form->setButton2("• §cHủy bỏ", 2);
		$form->sendToPlayer($sender);
	}
	...
	public function rank4($sender){
		...
		$form->setTitle("§f•§e Mua§6 VIP§f •");
		$form->setContent("• §eMua §aVIP§e-§cIV §evới giá 100 Point,bạn có muốn mua không?Các quyền lợi của §aVIP§e-§cIV §eáp dụng từ ngày 2/4\n §c► §a/tp\n §c► §a/fly\n §c► §a/kichthuoc\n §c► §a/god(god là bất tử)\n§c ►§a /canh\n§c►§a /feed");
		$form->setButton1("• §atap để mua", 1);
		$form->setButton2("• §chùy bỏ", 2);
		$form->sendToPlayer($sender);
	}
	...
	public function rank5($sender){
		...
		$form->setTitle("§f•§e Mua§6 VIP§f •");
		$form->setContent("• §eMua §aVIP§e-§cV §evới giá 200 Point ,bạn có muốn mua không?Các quyền lợi của §aVIP§e-§cV §eáp dụng từ ngày 2/4\n §c►§a /tp\n §c►§a /fly\n §c►§a /kichthuoc\n §c►§a /god(god là bất tử)\n §c►§a /vanish(vanish là tàng hình)\n§c ►§a /canh\n§c ►§a /feed");
		$form->setButton1("• §atap để mua", 1);
		$form->setButton2("• §chùy bỏ", 2);
		$form->sendToPlayer($sender);
	}
