...
use DaPigGuy\PiggyCustomEnchantsShop\libs\jojoe77777\FormAPI\CustomForm;
use DaPigGuy\PiggyCustomEnchantsShop\libs\jojoe77777\FormAPI\SimpleForm;
...
class CustomEnchantShopCommand extends PluginCommand
{
    ...
    public function confirmTransaction(Player $player, $index)
    {
        ...
        if ($plugin instanceof Main) {
            ...
            $form->addButton("§l§acó");
            $form->addButton("§l§ckhông");
            $player->sendForm($form);
